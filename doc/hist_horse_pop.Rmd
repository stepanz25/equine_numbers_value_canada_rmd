...
```{r plot horses, fig.width=10, fig.height=3, fig.cap="Figure 1. Horse populations for all provinces in Canada between 1940 - 1972.", out.width="70%", fig.align='center'}
...
max_horses <- horse_pop %>% 
  ...
  summarize(Maximum = max(Value),
            Minimum = min(Value))
knitr::kable(max_horses, caption = "Table 1. Minimum and Maximum number of horses in Canadian provinces between 1940 and 1972.") |> 
