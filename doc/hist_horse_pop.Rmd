...
```{r plot horses, fig.width=10, fig.height=3, fig.cap="Figure 1. Horse populations for all provinces in Canada between 1940 - 1972.", out.width="60%", fig.align='center'}
...
max_horses <- horse_pop %>% 
  ...
  summarize(Maximum = max(Value),
            Minimum = min(Value))
knitr::kable(max_horses, caption = "Table 1. Minimum (min) and Maximum (max) number of horses in Canadian provinces between 1940 and 1972.") |> 
  kableExtra::kable_styling(full_width = FALSE)
```

Below we zoom in and look at the province of `r params$province`:

```{r plot province, fig.width=5, fig.height=4, fig.cap = "Figure 2. Number of horses for a Canadian province of focus.", out.width = "50%", fig.align='center', warning=FALSE}
